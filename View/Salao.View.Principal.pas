...
uses
  ...
  FMX.MultiView, FMX.StdCtrls, FMX.Objects, Salao.View.Faturamento;
...
uses Salao.View.Servicos, Salao.View.Clientes, Salao.View.Profissionais,
  Salao.View.Pagamentos;
